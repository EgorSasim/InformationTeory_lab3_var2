...
P.S. Пытался сделать для больших чисел (BigInterger) (не особо получилось), можно поменять на long.
Проверок почти нет, писал на коленке вечером перед сдачей лабы.
